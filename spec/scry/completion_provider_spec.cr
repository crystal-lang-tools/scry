...
module Scry
  ...
  private macro it_completes(code, with_labels = nil)
    ...
    it "completes #{{{code}}.dump}" do
      ...
      results = response.as(LSP::Protocol::ResponseMessage).result.as(Array(LSP::Protocol::CompletionItem))
  ...
  describe CompletionProvider do
    ...
    context "module completion" do
      _kind_ = LSP::Protocol::CompletionItemKind::Module
    ...
    context "method completion" do
      _kind_ = LSP::Protocol::CompletionItemKind::Method
